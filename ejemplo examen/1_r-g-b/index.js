...
const getBlue = require('./blue-service/blue');
const getGreen = require('./green-service/green');
const getRed = require('./red-service/red');
const ipFilterMiddleware = require('./ipFilterMiddleware');
...
// endpoints
app.get('/blue', getBlue);
app.get('/green', getGreen);
app.get('/red', getRed);
